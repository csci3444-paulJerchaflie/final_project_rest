...
var TeacherRestController = function(TeacherModel) {
     ...
     * 
        curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 0, "name":"Paul", "lastname":"Jerchaflie", "title": "adjunct", "age":21, "isFullTime":false}' http://localhost:9016/teachers
        curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 1, "name":"Rob", "lastname":"Freeman", "title": "adjunct", "age":22, "isFullTime":false}' http://localhost:9016/teachers
        curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 2, "name":"Matt", "lastname":"Jacobs", "title": "full time", "age":23, "isFullTime":false}' http://localhost:9016/teachers
        curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"Peter", "lastname":"Jerchaflie", "title": "full time", "age":21, "isFullTime":true}' http://localhost:9016/teachers
        curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 4, "name":"ilker", "lastname":"Kiris", "title": "adjunct", "age":27, "isFullTime":true}' http://localhost:9016/teachers
 * 
     ...
     * 
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"paul_updated",   "lastname":"jerchaflie", "title":"full time", "age":21, "isFullTime":false}' http://localhost:9016/teachers/5a385cbd235e032f24c94eef
     ...
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{"grade":"sophomore", "age":123, "isFullTime":false}' http://localhost:9016/teachers/5a2634cd4d7bbb2edcfef2da
     * 
     * @param {*} req 
     * @param {*} res 
     */
